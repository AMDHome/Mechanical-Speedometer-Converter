 ...
 *  to calculate distance between two locations. Next, this distance is divided by the time difference of the location objects
 *  to derive speed. While the API also features a getSpeed() function, the consensus seems to be that this function is fairly
